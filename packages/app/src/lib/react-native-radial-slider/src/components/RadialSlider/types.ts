...
export type RootSliderProps = RadialSliderExcludedProps & RadialSliderProps;
...
export type RadialSliderProps = {
   ...
   */
  linearGradient?: {offset: string; color: string}[];
  linearGradientPlaceholder?: {offset: string; color: string}[];
  /**
