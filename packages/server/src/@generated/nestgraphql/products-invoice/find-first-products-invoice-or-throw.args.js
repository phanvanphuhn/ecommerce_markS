...
exports.FindFirstProductsInvoiceOrThrowArgs = void 0;
...
let FindFirstProductsInvoiceOrThrowArgs = class FindFirstProductsInvoiceOrThrowArgs {
};
__decorate([
...
], FindFirstProductsInvoiceOrThrowArgs.prototype, "where", void 0);
__decorate([
    (0, graphql_1.Field)(() => [products_invoice_order_by_with_relation_input_1.ProductsInvoiceOrderByWithRelationInput], { nullable: true })
], FindFirstProductsInvoiceOrThrowArgs.prototype, "orderBy", void 0);
__decorate([
    (0, graphql_1.Field)(() => products_invoice_where_unique_input_1.ProductsInvoiceWhereUniqueInput, { nullable: true })
], FindFirstProductsInvoiceOrThrowArgs.prototype, "cursor", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_3.Int, { nullable: true })
], FindFirstProductsInvoiceOrThrowArgs.prototype, "take", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_3.Int, { nullable: true })
], FindFirstProductsInvoiceOrThrowArgs.prototype, "skip", void 0);
__decorate([
    (0, graphql_1.Field)(() => [products_invoice_scalar_field_enum_1.ProductsInvoiceScalarFieldEnum], { nullable: true })
], FindFirstProductsInvoiceOrThrowArgs.prototype, "distinct", void 0);
FindFirstProductsInvoiceOrThrowArgs = __decorate([
    (0, graphql_2.ArgsType)()
], FindFirstProductsInvoiceOrThrowArgs);
exports.FindFirstProductsInvoiceOrThrowArgs = FindFirstProductsInvoiceOrThrowArgs;
//# sourceMappingURL=find-first-products-invoice-or-throw.args.js.map